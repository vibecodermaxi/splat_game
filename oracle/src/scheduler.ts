 ...
 *
 * Schedule is derived from ctx.config.cronSchedule (set from ROUND_DURATION_MINUTES env var).
 ...
 * simultaneously if the previous round's resolution takes longer than the window.
 *
