...
describe("ChainClient PDA derivation", () => {
  ...
  it("Test 4: IDL loads correctly — ChainClient can find idl.json", () => {
    // The ChainClient constructor loads the IDL from ./idl.json (oracle/src/idl.json),
    // a local copy generated by scripts/copy-idl.sh.
    ...
    expect(() => {
      // Path relative to oracle/src/__tests__/ -> go one level up to oracle/src/
